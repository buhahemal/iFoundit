...
var TagInputs = function() {
    ...
    var _componentTagsinput = function() {
        ...
        var citynames = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: {
                url: 'public/TemplateCss/global_assets/demo_data/tags_input/citynames.json',
        ...
        var countries = new Bloodhound({
            ...
            limit: 10,
            prefetch: {
                url: 'public/TemplateCss/global_assets/demo_data/tags_input/cities.json'
            }
        });
        ...
        var continents = new Bloodhound({
            ...
            limit: 10,
            prefetch: {
                url: 'pubilc/TemplateCss/global_assets/demo_data/tags_input/cities.json'
            }
        });
